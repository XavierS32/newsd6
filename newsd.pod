...
newsd - erco's simple nntp news server (IPv6-only downstream fork)
...
This version is a downstream fork that adds full IPv6-only support.
...
For bugs related to IPv6 implementation or NFSv4 compatibility, please
use the issue page of this fork:
https://github.com/XavierS32/newsd6/issues
...
=item Xavier Shen (IPv6 modifications, 2026)
...
Sweet. Portions copyright 2026 by Xavier Shen. This program is
